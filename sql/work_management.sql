...
CREATE TABLE `work_level_rule` (
  ...
  `position_type_id` bigint(20) NOT NULL COMMENT '职能类型 ID',
  ...
  `remark` varchar(512) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`rule_id`),
  UNIQUE KEY `uk_type_level` (`position_type_id`, `level`),
  KEY `idx_position_type_id` (`position_type_id`)
...
-- 初始化级别规则（5 职能类型 × 10 职级 = 50 条）
INSERT INTO work_level_rule(rule_id, position_type_id, level, level_name, min_stage, max_stage, description, status, del_flag, create_by, create_time, update_by, update_time, remark) VALUES 
(1, 1, 1, '初级 P1', '单体测试', '开发', '前端 P1 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(2, 1, 2, '初级 P2', '单体测试', '开发', '前端 P2 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(3, 1, 3, '初级 P3', '单体测试', '开发', '前端 P3 初级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(4, 1, 4, '中级 P4', '开发', '结合测试', '前端 P4 中级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(5, 1, 5, '高级 P5', '内部设计', '综合测试', '前端 P5 高级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(6, 1, 6, '资深 P6', '基本设计', '内部设计', '前端 P6 资深员工', '0', '0', '', NOW(), '', NOW(), NULL),
(7, 1, 7, '专家 P7', '需求分析', '基本设计', '前端 P7 专家', '0', '0', '', NOW(), '', NOW(), NULL),
(8, 1, 8, '高级专家 P8', '需求分析', '基本设计', '前端 P8 高级专家', '0', '0', '', NOW(), '', NOW(), NULL),
(9, 1, 9, '资深专家 P9', '需求分析', '需求分析', '前端 P9 资深专家', '0', '0', '', NOW(), '', NOW(), NULL),
(10, 1, 10, '首席专家 P10', '需求分析', '需求分析', '前端 P10 首席专家', '0', '0', '', NOW(), '', NOW(), NULL),
(11, 2, 1, '初级 P1', '单体测试', '开发', '后端 P1 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(12, 2, 2, '初级 P2', '单体测试', '开发', '后端 P2 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(13, 2, 3, '初级 P3', '单体测试', '开发', '后端 P3 初级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(14, 2, 4, '中级 P4', '开发', '结合测试', '后端 P4 中级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(15, 2, 5, '高级 P5', '内部设计', '综合测试', '后端 P5 高级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(16, 2, 6, '资深 P6', '基本设计', '内部设计', '后端 P6 资深员工', '0', '0', '', NOW(), '', NOW(), NULL),
(17, 2, 7, '专家 P7', '需求分析', '基本设计', '后端 P7 专家', '0', '0', '', NOW(), '', NOW(), NULL),
(18, 2, 8, '高级专家 P8', '需求分析', '基本设计', '后端 P8 高级专家', '0', '0', '', NOW(), '', NOW(), NULL),
(19, 2, 9, '资深专家 P9', '需求分析', '需求分析', '后端 P9 资深专家', '0', '0', '', NOW(), '', NOW(), NULL),
(20, 2, 10, '首席专家 P10', '需求分析', '需求分析', '后端 P10 首席专家', '0', '0', '', NOW(), '', NOW(), NULL),
(21, 3, 1, '初级 P1', '单体测试', '开发', '测试 P1 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(22, 3, 2, '初级 P2', '单体测试', '开发', '测试 P2 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(23, 3, 3, '初级 P3', '单体测试', '开发', '测试 P3 初级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(24, 3, 4, '中级 P4', '开发', '结合测试', '测试 P4 中级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(25, 3, 5, '高级 P5', '内部设计', '综合测试', '测试 P5 高级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(26, 3, 6, '资深 P6', '基本设计', '内部设计', '测试 P6 资深员工', '0', '0', '', NOW(), '', NOW(), NULL),
(27, 3, 7, '专家 P7', '需求分析', '基本设计', '测试 P7 专家', '0', '0', '', NOW(), '', NOW(), NULL),
(28, 3, 8, '高级专家 P8', '需求分析', '基本设计', '测试 P8 高级专家', '0', '0', '', NOW(), '', NOW(), NULL),
(29, 3, 9, '资深专家 P9', '需求分析', '需求分析', '测试 P9 资深专家', '0', '0', '', NOW(), '', NOW(), NULL),
(30, 3, 10, '首席专家 P10', '需求分析', '需求分析', '测试 P10 首席专家', '0', '0', '', NOW(), '', NOW(), NULL),
(31, 4, 1, '初级 P1', '单体测试', '开发', '产品 P1 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(32, 4, 2, '初级 P2', '单体测试', '开发', '产品 P2 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(33, 4, 3, '初级 P3', '单体测试', '开发', '产品 P3 初级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(34, 4, 4, '中级 P4', '开发', '结合测试', '产品 P4 中级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(35, 4, 5, '高级 P5', '内部设计', '综合测试', '产品 P5 高级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(36, 4, 6, '资深 P6', '基本设计', '内部设计', '产品 P6 资深员工', '0', '0', '', NOW(), '', NOW(), NULL),
(37, 4, 7, '专家 P7', '需求分析', '基本设计', '产品 P7 专家', '0', '0', '', NOW(), '', NOW(), NULL),
(38, 4, 8, '高级专家 P8', '需求分析', '基本设计', '产品 P8 高级专家', '0', '0', '', NOW(), '', NOW(), NULL),
(39, 4, 9, '资深专家 P9', '需求分析', '需求分析', '产品 P9 资深专家', '0', '0', '', NOW(), '', NOW(), NULL),
(40, 4, 10, '首席专家 P10', '需求分析', '需求分析', '产品 P10 首席专家', '0', '0', '', NOW(), '', NOW(), NULL),
(41, 5, 1, '初级 P1', '单体测试', '开发', '项目管理 P1 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(42, 5, 2, '初级 P2', '单体测试', '开发', '项目管理 P2 入门级', '0', '0', '', NOW(), '', NOW(), NULL),
(43, 5, 3, '初级 P3', '单体测试', '开发', '项目管理 P3 初级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(44, 5, 4, '中级 P4', '开发', '结合测试', '项目管理 P4 中级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(45, 5, 5, '高级 P5', '内部设计', '综合测试', '项目管理 P5 高级员工', '0', '0', '', NOW(), '', NOW(), NULL),
(46, 5, 6, '资深 P6', '基本设计', '内部设计', '项目管理 P6 资深员工', '0', '0', '', NOW(), '', NOW(), NULL),
(47, 5, 7, '专家 P7', '需求分析', '基本设计', '项目管理 P7 专家', '0', '0', '', NOW(), '', NOW(), NULL),
(48, 5, 8, '高级专家 P8', '需求分析', '基本设计', '项目管理 P8 高级专家', '0', '0', '', NOW(), '', NOW(), NULL),
(49, 5, 9, '资深专家 P9', '需求分析', '需求分析', '项目管理 P9 资深专家', '0', '0', '', NOW(), '', NOW(), NULL),
(50, 5, 10, '首席专家 P10', '需求分析', '需求分析', '项目管理 P10 首席专家', '0', '0', '', NOW(), '', NOW(), NULL);
